<%@ page import="com.example.demo.Model.Entity.Department" %>
<%@ page import="com.example.demo.Model.Database.DatabaseStaffDepartment" %>
<%@ page import="com.example.demo.Model.Entity.Staff" %>
<%@ page import="java.util.ArrayList" %>
<%@ page import="com.example.demo.Model.Entity.Task" %>
<%@ page import="com.example.demo.Model.Database.DatabaseTask" %>
<%@ page import="com.example.demo.Model.Database.DatabaseStaffTask" %>
            ...
            <div class="form_boxD">
                <table cellpadding="0" cellspacing="0">
                    ...
                    <%
                        ...
                        ArrayList<Staff> staffs =databaseStaffTask.searchStaffInDepartment(task);
